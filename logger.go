...
func Debug(f interface{}, v ...interface{}) *Logging {
	_print(default_format, LEVEL_DEBUG, default_level, 2, f, v...)
	return _staticLogger()
}

// Logs are printed at the INFO level
func Info(f interface{}, v ...interface{}) *Logging {
	_print(default_format, LEVEL_INFO, default_level, 2, f, v...)
	return _staticLogger()
}

// Logs are printed at the WARN level
func Warn(f interface{}, v ...interface{}) *Logging {
	_print(default_format, LEVEL_WARN, default_level, 2, f, v...)
	return _staticLogger()
}

// Logs are printed at the ERROR level
func Error(f interface{}, v ...interface{}) *Logging {
	_print(default_format, LEVEL_ERROR, default_level, 2, f, v...)
	return _staticLogger()
}

// Logs are printed at the FATAL level
func Fatal(f interface{}, v ...interface{}) *Logging {
	_print(default_format, LEVEL_FATAL, default_level, 2, f, v...)
	return _staticLogger()
}

func _print(_format _FORMAT, level, _default_level _LEVEL, calldepth int, f interface{}, v ...interface{}) {
	if level < _default_level {
		return
	}
	_staticLogger().println(level, k1(calldepth), f, v...)
}

func __print(_format _FORMAT, level, _default_level _LEVEL, calldepth int, f interface{}, v ...interface{}) {
	_console([]byte(formatPattern(f, v...)), getlevelname(level, default_format), _format, k1(calldepth))
}
...
func (t *Logging) Debug(f interface{}, v ...interface{}) *Logging {
	t.println(LEVEL_DEBUG, 2, f, v...)
	return t
}
func (t *Logging) Info(f interface{}, v ...interface{}) *Logging {
	t.println(LEVEL_INFO, 2, f, v...)
	return t
}
func (t *Logging) Warn(f interface{}, v ...interface{}) *Logging {
	t.println(LEVEL_WARN, 2, f, v...)
	return t
}
func (t *Logging) Error(f interface{}, v ...interface{}) *Logging {
	t.println(LEVEL_ERROR, 2, f, v...)
	return t
}
func (t *Logging) Fatal(f interface{}, v ...interface{}) *Logging {
	t.println(LEVEL_FATAL, 2, f, v...)
	return t
}
...
func (t *Logging) println(_level _LEVEL, calldepth int, f interface{}, v ...interface{}) {
	if t._level > _level {
		return
	}
	if t._fileObj._isFileWell {
	...
	if t._isConsole {
		__print(t._format, _level, t._level, k1(calldepth), f, v...)
	}
}
